...
const CreatePlayers = (props: any) => {
	...
	return (
		<div className='flex-center'>
			<div className='create-players__grid'>{getPlayer}</div>
			<form className='create-players' onSubmit={add}>
				{props.getPlayer.length === props.count ? (
					<>
						...
						<img
							className='create-players__theme'
							src={props.theme.selectedTheme}
							alt='img'
						/>
						<br />
						<button
							...
							className='create-players__button-next'
							src={buttonNext}
							alt='img'
						/>
					</>
					...
					<>
						<img className='create-players__profile' src={human} alt='img' />
						<br />
						<input
							placeholder='Write name...'
							className='create-players__name'
							type='text'
							value={name}
